<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML+RDFa 1.0//EN"
 ...
 ?>
   ...
   <input type="submit" name="logout_button" value="Logout" onclick="window.location = 'php_page_logout.php';"/>
   </div>
   <div id="wrapper">
   ...
   <div  class="row_data">
   <div class="row_action" id="row_edit"><a href="php_page_edit.php?uid=<?php echo $value['ID'];?>">Edit</a></div>
   <div class="row_action" id="row_delete"><a href="php_page_delete.php?uid=<?php echo $value['ID'];?>">Delete</a></div>
   </div>
   <?php }?>
   </div>
   <?php
