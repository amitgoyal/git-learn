      ...
      <div id="wrapper">
        ...
        <div class="sub_wrapper">
            ...
            <div class="header">                              
                ...
                <div class="heading">
                <h5> <?php echo $value[u_id];?></h5>
                </div>
                <div class="heading">
                <h5>  <?php echo $value[u_ename];?></h5>
                </div>    
                <div class="heading">
                <h5> <?php echo $value[u_email];?> </h5>
                </div>    
                <div class="heading">
                <h5> <?php echo $value[u_address];?></h5>
                </div>
                <div class="heading">
                   <a href="edit.php?uid=<?php echo $value['u_id']; ?>">Edit</a>|<a href="delete.php?uid=<?php echo $value['u_id']; ?>">Delete</a>
                </div>
                <?php } ?>                
            </div>  
        </div>
